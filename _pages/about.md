...
<div class="pub-card">
  ...
  <div class="pub-title">On Autopilot? An Empirical Study of Human-AI Teaming and Review Practices in Open Source</div>
...
<div class="pub-card" style="border-left: 3px solid #d97706;">
  <span class="pub-venue" style="background: #fef3c7; color: #92400e;">EMSE (Major Revision)</span>
  <div class="pub-title">AI Safety in the Eyes of the Downstream Developer: A First Look at Concerns, Practices, and Challenges</div>
  <div class="pub-authors"><strong>H. Gao</strong>, M. Zahedi, W. Jiang, H. Lin, J. Davis, and C. Treude</div>
</div>

<div class="pub-card" style="border-left: 3px solid #d97706;">
  <span class="pub-venue" style="background: #fef3c7; color: #92400e;">TSE (Major Revision)</span>
  <div class="pub-title">Does My README File Need To Be Updated? Exploring LLM-Based README Maintenance</div>
  <div class="pub-authors"><strong>H. Gao</strong>, H. Lin, C. Treude, G. Gay, and M. Zahedi</div>
</div>

<div class="pub-card" style="border-left: 3px solid #9ca3af;">
  <span class="pub-venue" style="background: #f3f4f6; color: #4b5563;">Under Submission</span>
  <div class="pub-title">When AI Models Become Dependencies: Studying the Evolution of Pre-Trained Model Reuse in Downstream Software Systems</div>
  <div class="pub-authors">P. Banyongrakkul, M. Zahedi, C. Treude, <strong>H. Gao</strong>, and P. Thongtanunam</div>
</div>

<div class="pub-card" style="border-left: 3px solid #9ca3af;">
  <span class="pub-venue" style="background: #f3f4f6; color: #4b5563;">Under Submission</span>
  <div class="pub-title">Fine-grained Approaches for Confidence Calibration of LLMs in Automated Code Revision</div>
  <div class="pub-authors">H. Lin, C. Liu, <strong>H. Gao</strong>, P. Thongtanunam, and C. Treude</div>
</div>
